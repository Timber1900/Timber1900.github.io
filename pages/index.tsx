      ...
      <div className="grid min-h-screen gap-0 font-sans bg-white dark:bg-gray-800 grid-rows-pancake">
        ...
        <div className="z-0 grid w-full h-full grid-cols-2 gap-6 px-6 py-2 lg:grid-cols-4 auto-rows-auto lg:gap-12 lg:px-12">
            ...
            <div className="flex flex-col items-center justify-start w-full h-auto p-4 my-auto rounded-md">
              <div className="flex flex-row group place-items-center">
                ...
                <label htmlFor='downloadWebDL'>
                  <a href="https://www.github.com/Timber1900/WebDL/releases/latest" className="inline-block font-bold text-indigo-800 transition-colors duration-300 group-hover:text-indigo-600 dark:group-hover:text-blue-200 dark:text-blue-400">Download</a>
                </label>
              </div>
              <Link href="/webdl" as={process.env.BACKEND_URL + '/webdl'}>
          ...
          <div className="grid grid-cols-1 col-span-2 gap-2 text-2xl font-extrabold text-black bg-gray-200 shadow-md dark:bg-gray-700 place-items-center min-h-card rounded-xl dark:text-white 2xl:grid-cols-2 2xl:grid-rows-2">
            ...
            <div className="flex flex-col items-center justify-start w-full h-auto p-4 my-auto rounded-md">
              <a href="https://www.github.com/Timber1900/OpenTK-3D-Engine" className="inline-block font-bold text-left text-indigo-800 transition-colors duration-300 hover:text-indigo-600 dark:hover:text-blue-200 dark:text-blue-400">{"•"} Github</a>
              ...
              <a href="OpenTK-3D-Engine/" className="inline-block font-bold text-left text-indigo-800 transition-colors duration-300 hover:text-indigo-600 dark:hover:text-blue-200 dark:text-blue-400">{"•"} Documentation</a>
          ...
          <div className="grid grid-cols-1 col-span-2 col-start-1 gap-2 text-2xl font-extrabold text-black bg-gray-200 shadow-md dark:bg-gray-700 lg:col-start-2 place-items-center min-h-card rounded-xl dark:text-white 2xl:grid-cols-2 2xl:grid-rows-2">
            ...
            <div className="flex flex-col items-center justify-start w-full h-auto p-4 my-auto rounded-md">
              <a href="https://www.github.com/Timber1900/3d-parametric-function-viewer" className="inline-block font-bold text-left text-indigo-800 transition-colors duration-300 hover:text-indigo-600 dark:hover:text-blue-200 dark:text-blue-400">{"•"} Github</a>
              <a href="3d-parametric-function-viewer/" className="inline-block font-bold text-left text-indigo-800 transition-colors duration-300 hover:text-indigo-600 dark:hover:text-blue-200 dark:text-blue-400">{"•"} Website</a>
            </div>
          </div>
        </div>
        <Footer/>
