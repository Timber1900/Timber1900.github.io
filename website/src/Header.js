...
const Header = () => {
  ...
  return(
    <header className="bg-white dark:bg-gray-800 w-full flex justify-center custombp:sticky custombp:top-0">
      <div className="flex h-20 place-items-center my-2 border-b border-gray-200 dark:border-gray-700 w-full-minus-padding-small sm:w-full-minus-padding relative">
        <h1 className="text-center text-xl sm:text-4xl font-sans font-bold mx-auto text-black dark:text-white">Hugo's Github Projects</h1>
