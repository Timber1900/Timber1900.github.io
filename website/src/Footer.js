    ...
    <footer className="bg-white dark:bg-gray-800 w-full flex justify-center sticky bottom-0">
      <div className="relative flex h-20 justify-center place-items-center sd:flex-row flex-col border-t border-gray-200 dark:border-gray-700 w-full-minus-padding my-2 max-w-full-minus-padding">
        <div className="md:absolute md:right-0 flex justify-center place-items-center">
          <div className="flex flex-row group px-1 sd:px-2 w-auto h-auto place-items-center" onClick={() => {window.open("https://discord.com/users/263073389432930314")}}>
          ...
          <div className="flex flex-row group px-1 sd:px-2 w-auto h-auto place-items-center" onClick={() => {window.open("https://github.com/timber1900")}}>
          ...
          <div className="flex flex-row group px-1 sd:px-2 w-auto h-auto place-items-center" onClick={() => {window.open("https://www.twitch.tv/timber1900")}}>
          ...
          <div className="flex flex-row group px-1 sd:px-2 w-auto h-auto place-items-center" onClick={() => {window.open("https://www.youtube.com/channel/UC8QDXDI7nTM3T-qEDAn37OA")}}>
          ...
          <div className="flex flex-row group px-1 sd:px-2 w-auto h-auto place-items-center" onClick={() => {window.open("https://steamcommunity.com/id/timber1900/")}}>
