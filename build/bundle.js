var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			t14 = space();
    			p4 = element("p");
    			p4.textContent = "Twitch";
    			attr(p0, "class", "svelte-zxm939");
    			attr(div0, "class", "svg-div svelte-zxm939");
    			attr(p1, "class", "svelte-zxm939");
    			attr(div1, "class", "svg-div svelte-zxm939");
    			attr(p2, "class", "svelte-zxm939");
    			attr(div2, "class", "svg-div svelte-zxm939");
    			attr(p3, "class", "svelte-zxm939");
    			attr(div3, "class", "svg-div svelte-zxm939");
    			attr(p4, "class", "svelte-zxm939");
    			attr(div4, "class", "svg-div svelte-zxm939");
    			attr(div5, "class", "icons-outer svelte-zxm939");
    			attr(header, "class", "text-primary-color dark-primary-color svelte-zxm939");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(footer, "class", "text-primary-color dark-primary-color svelte-1osfnup");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<p class="text-primary-color">LeftSidebar</p>`;
    			attr(div, "class", "left-side svelte-nruo5v");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(main, "class", "text-primary-color svelte-17gu4eh");
    		},
    		m(target, anchor) {
